...
class __Mustache_d93865569fbe32622bdac9897adc2b4d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1bf492c0653de1efecd72b86cf061829($context, $indent, $value);
...
';
    ...
    private function sectionAdd8ee5623f010026653932c13c16ac4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' resizelayout, mod_assign ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= ' resizelayout, mod_assign ';
                $context->pop();
            }
        }
    ...
    private function section1bf492c0653de1efecd72b86cf061829(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div data-region="resizer" tabindex="0" aria-label="{{#str}} resizelayout, mod_assign {{/str}}" title="{{#str}} resizelayout, mod_assign {{/str}}"></div>
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
...
';
                $buffer .= $indent . '</div>
';
                $buffer .= $indent . '<div data-region="resizer" tabindex="0" aria-label="';
                $value = $context->find('str');
                $buffer .= $this->sectionAdd8ee5623f010026653932c13c16ac4($context, $indent, $value);
                $buffer .= '" title="';
                $value = $context->find('str');
                $buffer .= $this->sectionAdd8ee5623f010026653932c13c16ac4($context, $indent, $value);
                $buffer .= '"></div>
